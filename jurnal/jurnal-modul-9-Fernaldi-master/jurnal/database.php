...
class database{
	...
	function input($nama,$alamat,$usia){
		...
		$que = mysqli_query($this->conn,"INSERT INTO user VALUES ('','$nama','$alamat','$usia')");
	}
	...
	function update($id,$nama,$alamat,$usia){
		...
		$que = mysqli_query($this->conn, "UPDATE `user` SET nama='$nama',alamat='$alamat',usia='$usia' WHERE id='$id'");
